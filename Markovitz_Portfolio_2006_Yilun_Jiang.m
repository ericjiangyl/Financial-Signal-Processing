...
filename = '48_Industry_Portofolios_daily_2006.txt';
filename1 = 'SP500_daily_index_2006.txt';
delimiterIn = ' ';
delimiterIn1 = '\n';
...
% and the resulting risk is 0.68927, 1.4306 and 3.1129
...
% The graph indeed corresponds to the intuition and the theory. The MVP
% protfolio has the lowest fluctuation comparing to all six portfolios. The
% theoratical market portfolio has the second largest peak among all. The
% one portfolio that has a higher return than the market portfolio is the
% portfolio 3 chosen at Question D, but that's because I set the expected return for
% this portfolio to be 1.52 while the expected return for the market
% portfolio is 0.89. However, overall the theoratical market portfolio is
% still the best choice in my opinion. As in the graph, the portfolio 3
% chosen at Question D perform much worse than the market portfolio when the time is
% bad.